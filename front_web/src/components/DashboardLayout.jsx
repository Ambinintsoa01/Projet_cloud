    ...
    switch (location.pathname) {
      ...
      case '/dashboard/map':
        return {
          ...
          subtitle: 'Localisation des signalements en temps réel',
          icon: (
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      case '/dashboard/reports':
        return {
          title: 'Signalements',
          subtitle: 'Gestion des rapports de routes endommagées',
          icon: (
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      case '/dashboard/users':
        return {
          title: 'Utilisateurs',
          subtitle: 'Gestion des citoyens et administrateurs',
          icon: (
            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
